...
DLL_API2 signed char     F_API FSOUND_SetOutput(int outputtype);
DLL_API2 signed char     F_API FSOUND_SetDriver(int driver);
DLL_API2 signed char     F_API FSOUND_SetMixer(int mixer);
DLL_API2 signed char     F_API FSOUND_SetBufferSize(int len_ms);
DLL_API2 signed char     F_API FSOUND_SetHWND(void *hwnd);
DLL_API2 signed char     F_API FSOUND_SetMinHardwareChannels(int min);
DLL_API2 signed char     F_API FSOUND_SetMaxHardwareChannels(int max);
DLL_API2 signed char     F_API FSOUND_SetMemorySystem(void *pool, 
                                                     int poollen, 
...
DLL_API2 signed char     F_API FSOUND_Init(int mixrate, int maxsoftwarechannels, unsigned int flags);
DLL_API2 void            F_API FSOUND_Close();

/* 
    Runtime system level functions 
*/

DLL_API2 void            F_API FSOUND_Update();   /* This is called to update 3d sound / non-realtime output */

DLL_API2 void            F_API FSOUND_SetSpeakerMode(unsigned int speakermode);
DLL_API2 void            F_API FSOUND_SetSFXMasterVolume(int volume);
DLL_API2 void            F_API FSOUND_SetPanSeperation(float pansep);
DLL_API2 void            F_API FSOUND_File_SetCallbacks(FSOUND_OPENCALLBACK  useropen,
...
DLL_API2 int             F_API FSOUND_GetError();
DLL_API2 float           F_API FSOUND_GetVersion();
DLL_API2 int             F_API FSOUND_GetOutput();
DLL_API2 void *          F_API FSOUND_GetOutputHandle();
DLL_API2 int             F_API FSOUND_GetDriver();
DLL_API2 int             F_API FSOUND_GetMixer();
DLL_API2 int             F_API FSOUND_GetNumDrivers();
DLL_API2 const char *    F_API FSOUND_GetDriverName(int id);
DLL_API2 signed char     F_API FSOUND_GetDriverCaps(int id, unsigned int *caps);
DLL_API2 int             F_API FSOUND_GetOutputRate();
DLL_API2 int             F_API FSOUND_GetMaxChannels();
DLL_API2 int             F_API FSOUND_GetMaxSamples();
DLL_API2 int             F_API FSOUND_GetSFXMasterVolume();
DLL_API2 int             F_API FSOUND_GetNumHardwareChannels();
DLL_API2 int             F_API FSOUND_GetChannelsPlaying();
DLL_API2 float           F_API FSOUND_GetCPUUsage();
DLL_API2 void            F_API FSOUND_GetMemoryStats(unsigned int *currentalloced, unsigned int *maxalloced);
...
DLL_API2 FSOUND_SAMPLE * F_API FSOUND_Sample_Load(int index, const char *name_or_data, unsigned int mode, int offset, int length);
DLL_API2 FSOUND_SAMPLE * F_API FSOUND_Sample_Alloc(int index, int length, unsigned int mode, int deffreq, int defvol, int defpan, int defpri);
DLL_API2 void            F_API FSOUND_Sample_Free(FSOUND_SAMPLE *sptr);
DLL_API2 signed char     F_API FSOUND_Sample_Upload(FSOUND_SAMPLE *sptr, void *srcdata, unsigned int mode);
DLL_API2 signed char     F_API FSOUND_Sample_Lock(FSOUND_SAMPLE *sptr, int offset, int length, void **ptr1, void **ptr2, unsigned int *len1, unsigned int *len2);
DLL_API2 signed char     F_API FSOUND_Sample_Unlock(FSOUND_SAMPLE *sptr, void *ptr1, void *ptr2, unsigned int len1, unsigned int len2);

/*
    Sample control functions
*/

DLL_API2 signed char     F_API FSOUND_Sample_SetMode(FSOUND_SAMPLE *sptr, unsigned int mode);
DLL_API2 signed char     F_API FSOUND_Sample_SetLoopPoints(FSOUND_SAMPLE *sptr, int loopstart, int loopend);
DLL_API2 signed char     F_API FSOUND_Sample_SetDefaults(FSOUND_SAMPLE *sptr, int deffreq, int defvol, int defpan, int defpri);
DLL_API2 signed char     F_API FSOUND_Sample_SetMinMaxDistance(FSOUND_SAMPLE *sptr, float min, float max);
DLL_API2 signed char     F_API FSOUND_Sample_SetMaxPlaybacks(FSOUND_SAMPLE *sptr, int max);

/* 
    Sample information functions
*/

DLL_API2 FSOUND_SAMPLE * F_API FSOUND_Sample_Get(int sampno);
DLL_API2 const char *    F_API FSOUND_Sample_GetName(FSOUND_SAMPLE *sptr);
DLL_API2 unsigned int    F_API FSOUND_Sample_GetLength(FSOUND_SAMPLE *sptr);
DLL_API2 signed char     F_API FSOUND_Sample_GetLoopPoints(FSOUND_SAMPLE *sptr, int *loopstart, int *loopend);
DLL_API2 signed char     F_API FSOUND_Sample_GetDefaults(FSOUND_SAMPLE *sptr, int *deffreq, int *defvol, int *defpan, int *defpri);
DLL_API2 unsigned int    F_API FSOUND_Sample_GetMode(FSOUND_SAMPLE *sptr);
...
DLL_API2 int             F_API FSOUND_PlaySound(int channel, FSOUND_SAMPLE *sptr);
DLL_API2 int             F_API FSOUND_PlaySoundEx(int channel, FSOUND_SAMPLE *sptr, FSOUND_DSPUNIT *dsp, signed char startpaused);
DLL_API2 signed char     F_API FSOUND_StopSound(int channel);
...
DLL_API2 signed char     F_API FSOUND_SetFrequency(int channel, int freq);
DLL_API2 signed char     F_API FSOUND_SetVolume(int channel, int vol);
DLL_API2 signed char     F_API FSOUND_SetVolumeAbsolute(int channel, int vol);
DLL_API2 signed char     F_API FSOUND_SetPan(int channel, int pan);
DLL_API2 signed char     F_API FSOUND_SetSurround(int channel, signed char surround);
DLL_API2 signed char     F_API FSOUND_SetMute(int channel, signed char mute);
DLL_API2 signed char     F_API FSOUND_SetPriority(int channel, int priority);
DLL_API2 signed char     F_API FSOUND_SetReserved(int channel, signed char reserved);
DLL_API2 signed char     F_API FSOUND_SetPaused(int channel, signed char paused);
DLL_API2 signed char     F_API FSOUND_SetLoopMode(int channel, unsigned int loopmode);
DLL_API2 signed char     F_API FSOUND_SetCurrentPosition(int channel, unsigned int offset);

/* 
    Channel information functions.
*/

DLL_API2 signed char     F_API FSOUND_IsPlaying(int channel);
DLL_API2 int             F_API FSOUND_GetFrequency(int channel);
DLL_API2 int             F_API FSOUND_GetVolume(int channel);
DLL_API2 int             F_API FSOUND_GetPan(int channel);
DLL_API2 signed char     F_API FSOUND_GetSurround(int channel);
DLL_API2 signed char     F_API FSOUND_GetMute(int channel);
DLL_API2 int             F_API FSOUND_GetPriority(int channel);
DLL_API2 signed char     F_API FSOUND_GetReserved(int channel);
DLL_API2 signed char     F_API FSOUND_GetPaused(int channel);
DLL_API2 unsigned int    F_API FSOUND_GetLoopMode(int channel);
DLL_API2 unsigned int    F_API FSOUND_GetCurrentPosition(int channel);
DLL_API2 FSOUND_SAMPLE * F_API FSOUND_GetCurrentSample(int channel);
DLL_API2 signed char     F_API FSOUND_GetCurrentLevels(int channel, float *l, float *r);
DLL_API2 int             F_API FSOUND_GetNumSubChannels(int channel);
DLL_API2 int             F_API FSOUND_GetSubChannel(int channel, int subchannel);
...
DLL_API2 int             F_API FSOUND_FX_Enable(int channel, unsigned int fx);    /* See FSOUND_FX_MODES */
DLL_API2 signed char     F_API FSOUND_FX_Disable(int channel);    

DLL_API2 signed char     F_API FSOUND_FX_SetChorus(int fxid, float WetDryMix, float Depth, float Feedback, float Frequency, int Waveform, float Delay, int Phase);
DLL_API2 signed char     F_API FSOUND_FX_SetCompressor(int fxid, float Gain, float Attack, float Release, float Threshold, float Ratio, float Predelay);
DLL_API2 signed char     F_API FSOUND_FX_SetDistortion(int fxid, float Gain, float Edge, float PostEQCenterFrequency, float PostEQBandwidth, float PreLowpassCutoff);
DLL_API2 signed char     F_API FSOUND_FX_SetEcho(int fxid, float WetDryMix, float Feedback, float LeftDelay, float RightDelay, int PanDelay);
DLL_API2 signed char     F_API FSOUND_FX_SetFlanger(int fxid, float WetDryMix, float Depth, float Feedback, float Frequency, int Waveform, float Delay, int Phase);
DLL_API2 signed char     F_API FSOUND_FX_SetGargle(int fxid, int RateHz, int WaveShape);
DLL_API2 signed char     F_API FSOUND_FX_SetI3DL2Reverb(int fxid, int Room, int RoomHF, float RoomRolloffFactor, float DecayTime, float DecayHFRatio, int Reflections, float ReflectionsDelay, int Reverb, float ReverbDelay, float Diffusion, float Density, float HFReference);
DLL_API2 signed char     F_API FSOUND_FX_SetParamEQ(int fxid, float Center, float Bandwidth, float Gain);
DLL_API2 signed char     F_API FSOUND_FX_SetWavesReverb(int fxid, float InGain, float ReverbMix, float ReverbTime, float HighFreqRTRatio);  
 
/* =================== */
/* 3D sound functions. */
/* =================== */

DLL_API2 void            F_API FSOUND_3D_SetDopplerFactor(float scale);
DLL_API2 void            F_API FSOUND_3D_SetDistanceFactor(float scale);
DLL_API2 void            F_API FSOUND_3D_SetRolloffFactor(float scale);
DLL_API2 signed char     F_API FSOUND_3D_SetAttributes(int channel, const float *pos, const float *vel);
DLL_API2 signed char     F_API FSOUND_3D_GetAttributes(int channel, float *pos, float *vel);

DLL_API2 void            F_API FSOUND_3D_Listener_SetCurrent(int current, int numlisteners);  /* use this if you use multiple listeners / splitscreen */
DLL_API2 void            F_API FSOUND_3D_Listener_SetAttributes(const float *pos, const float *vel, float fx, float fy, float fz, float tx, float ty, float tz);
DLL_API2 void            F_API FSOUND_3D_Listener_GetAttributes(float *pos, float *vel, float *fx, float *fy, float *fz, float *tx, float *ty, float *tz);
...
DLL_API2 signed char        F_API FSOUND_Stream_SetBufferSize(int ms);      /* call this before opening streams, not after */
                           
DLL_API2 FSOUND_STREAM *    F_API FSOUND_Stream_Open(const char *name_or_data, unsigned int mode, int offset, int length);
DLL_API2 FSOUND_STREAM *    F_API FSOUND_Stream_Create(FSOUND_STREAMCALLBACK callback, int length, unsigned int mode, int samplerate, int userdata);
DLL_API2 signed char        F_API FSOUND_Stream_Close(FSOUND_STREAM *stream);
                           
DLL_API2 int                F_API FSOUND_Stream_Play(int channel, FSOUND_STREAM *stream);
DLL_API2 int                F_API FSOUND_Stream_PlayEx(int channel, FSOUND_STREAM *stream, FSOUND_DSPUNIT *dsp, signed char startpaused);
DLL_API2 signed char        F_API FSOUND_Stream_Stop(FSOUND_STREAM *stream);
                           
DLL_API2 signed char        F_API FSOUND_Stream_SetPosition(FSOUND_STREAM *stream, unsigned int position);
DLL_API2 unsigned int       F_API FSOUND_Stream_GetPosition(FSOUND_STREAM *stream);
DLL_API2 signed char        F_API FSOUND_Stream_SetTime(FSOUND_STREAM *stream, int ms);
DLL_API2 int                F_API FSOUND_Stream_GetTime(FSOUND_STREAM *stream);
DLL_API2 int                F_API FSOUND_Stream_GetLength(FSOUND_STREAM *stream);
DLL_API2 int                F_API FSOUND_Stream_GetLengthMs(FSOUND_STREAM *stream);
                           
DLL_API2 signed char        F_API FSOUND_Stream_SetMode(FSOUND_STREAM *stream, unsigned int mode);
DLL_API2 unsigned int       F_API FSOUND_Stream_GetMode(FSOUND_STREAM *stream);
DLL_API2 signed char        F_API FSOUND_Stream_SetLoopPoints(FSOUND_STREAM *stream, unsigned int loopstartpcm, unsigned int loopendpcm);
DLL_API2 signed char        F_API FSOUND_Stream_SetLoopCount(FSOUND_STREAM *stream, int count);
DLL_API2 int                F_API FSOUND_Stream_GetOpenState(FSOUND_STREAM *stream);                /* use with FSOUND_NONBLOCKING opened streams */
DLL_API2 FSOUND_SAMPLE *    F_API FSOUND_Stream_GetSample(FSOUND_STREAM *stream);
DLL_API2 FSOUND_DSPUNIT *   F_API FSOUND_Stream_CreateDSP(FSOUND_STREAM *stream, FSOUND_DSPCALLBACK callback, int priority, int param);
                           
DLL_API2 signed char        F_API FSOUND_Stream_SetEndCallback(FSOUND_STREAM *stream, FSOUND_STREAMCALLBACK callback, int userdata);
DLL_API2 signed char        F_API FSOUND_Stream_SetSyncCallback(FSOUND_STREAM *stream, FSOUND_STREAMCALLBACK callback, int userdata);

DLL_API2 FSOUND_SYNCPOINT * F_API FSOUND_Stream_AddSyncPoint(FSOUND_STREAM *stream, unsigned int pcmoffset, const char *name);
DLL_API2 signed char        F_API FSOUND_Stream_DeleteSyncPoint(FSOUND_SYNCPOINT *point);
DLL_API2 int                F_API FSOUND_Stream_GetNumSyncPoints(FSOUND_STREAM *stream);
DLL_API2 FSOUND_SYNCPOINT * F_API FSOUND_Stream_GetSyncPoint(FSOUND_STREAM *stream, int index);
DLL_API2 char *             F_API FSOUND_Stream_GetSyncPointInfo(FSOUND_SYNCPOINT *point, unsigned int *pcmoffset);

DLL_API2 signed char        F_API FSOUND_Stream_SetSubStream(FSOUND_STREAM *stream, int index);     /* For FMOD .FSB bank files. */
DLL_API2 int                F_API FSOUND_Stream_GetNumSubStreams(FSOUND_STREAM *stream);            /* For FMOD .FSB bank files. */
DLL_API2 signed char        F_API FSOUND_Stream_SetSubStreamSentence(FSOUND_STREAM *stream, const int *sentencelist, int numitems);

DLL_API2 signed char        F_API FSOUND_Stream_GetNumTagFields(FSOUND_STREAM *stream, int *num);
DLL_API2 signed char        F_API FSOUND_Stream_GetTagField(FSOUND_STREAM *stream, int num, int *type, char **name, void **value, int *length);
DLL_API2 signed char        F_API FSOUND_Stream_FindTagField(FSOUND_STREAM *stream, int type, const char *name, void **value, int *length);

/*
    Internet streaming functions
*/

DLL_API2 signed char        F_API FSOUND_Stream_Net_SetProxy(const char *proxy);
DLL_API2 char *             F_API FSOUND_Stream_Net_GetLastServerStatus();
DLL_API2 signed char        F_API FSOUND_Stream_Net_SetBufferProperties(int buffersize, int prebuffer_percent, int rebuffer_percent);
DLL_API2 signed char        F_API FSOUND_Stream_Net_GetBufferProperties(int *buffersize, int *prebuffer_percent, int *rebuffer_percent);
DLL_API2 signed char        F_API FSOUND_Stream_Net_SetMetadataCallback(FSOUND_STREAM *stream, FSOUND_METADATACALLBACK callback, int userdata);
DLL_API2 signed char        F_API FSOUND_Stream_Net_GetStatus(FSOUND_STREAM *stream, int *status, int *bufferpercentused, int *bitrate, unsigned int *flags);
...
DLL_API2 signed char     F_API FSOUND_CD_Play(char drive, int track);
DLL_API2 void            F_API FSOUND_CD_SetPlayMode(char drive, signed char mode);
DLL_API2 signed char     F_API FSOUND_CD_Stop(char drive);
DLL_API2 signed char     F_API FSOUND_CD_SetPaused(char drive, signed char paused);
DLL_API2 signed char     F_API FSOUND_CD_SetVolume(char drive, int volume);
DLL_API2 signed char     F_API FSOUND_CD_SetTrackTime(char drive, unsigned int ms);
DLL_API2 signed char     F_API FSOUND_CD_Eject(char drive);

DLL_API2 signed char     F_API FSOUND_CD_GetPaused(char drive);
DLL_API2 int             F_API FSOUND_CD_GetTrack(char drive);
DLL_API2 int             F_API FSOUND_CD_GetNumTracks(char drive);
DLL_API2 int             F_API FSOUND_CD_GetVolume(char drive);
DLL_API2 int             F_API FSOUND_CD_GetTrackLength(char drive, int track); 
DLL_API2 int             F_API FSOUND_CD_GetTrackTime(char drive);
...
DLL_API2 FSOUND_DSPUNIT *F_API FSOUND_DSP_Create(FSOUND_DSPCALLBACK callback, int priority, int param);
DLL_API2 void            F_API FSOUND_DSP_Free(FSOUND_DSPUNIT *unit);
DLL_API2 void            F_API FSOUND_DSP_SetPriority(FSOUND_DSPUNIT *unit, int priority);
DLL_API2 int             F_API FSOUND_DSP_GetPriority(FSOUND_DSPUNIT *unit);
DLL_API2 void            F_API FSOUND_DSP_SetActive(FSOUND_DSPUNIT *unit, signed char active);
DLL_API2 signed char     F_API FSOUND_DSP_GetActive(FSOUND_DSPUNIT *unit);

/* 
    Functions to get hold of FSOUND 'system DSP unit' handles. 
*/

DLL_API2 FSOUND_DSPUNIT *F_API FSOUND_DSP_GetClearUnit();
DLL_API2 FSOUND_DSPUNIT *F_API FSOUND_DSP_GetSFXUnit();
DLL_API2 FSOUND_DSPUNIT *F_API FSOUND_DSP_GetMusicUnit();
DLL_API2 FSOUND_DSPUNIT *F_API FSOUND_DSP_GetFFTUnit();
DLL_API2 FSOUND_DSPUNIT *F_API FSOUND_DSP_GetClipAndCopyUnit();
...
DLL_API2 signed char     F_API FSOUND_DSP_MixBuffers(void *destbuffer, void *srcbuffer, int len, int freq, int vol, int pan, unsigned int mode);
DLL_API2 void            F_API FSOUND_DSP_ClearMixBuffer();
DLL_API2 int             F_API FSOUND_DSP_GetBufferLength();      /* Length of each DSP update */
DLL_API2 int             F_API FSOUND_DSP_GetBufferLengthTotal(); /* Total buffer length due to FSOUND_SetBufferSize */
DLL_API2 float *         F_API FSOUND_DSP_GetSpectrum();          /* Array of 512 floats - call FSOUND_DSP_SetActive(FSOUND_DSP_GetFFTUnit(), TRUE)) for this to work. */
...
DLL_API2 signed char     F_API FSOUND_Reverb_SetProperties(const FSOUND_REVERB_PROPERTIES *prop);
DLL_API2 signed char     F_API FSOUND_Reverb_GetProperties(FSOUND_REVERB_PROPERTIES *prop);
DLL_API2 signed char     F_API FSOUND_Reverb_SetChannelProperties(int channel, const FSOUND_REVERB_CHANNELPROPERTIES *prop);
DLL_API2 signed char     F_API FSOUND_Reverb_GetChannelProperties(int channel, FSOUND_REVERB_CHANNELPROPERTIES *prop);
...
DLL_API2 signed char     F_API FSOUND_Record_SetDriver(int outputtype);
DLL_API2 int             F_API FSOUND_Record_GetNumDrivers();
DLL_API2 const char *    F_API FSOUND_Record_GetDriverName(int id);
DLL_API2 int             F_API FSOUND_Record_GetDriver();

/*
    Recording functionality.  Only one recording session will work at a time.
*/

DLL_API2 signed char     F_API FSOUND_Record_StartSample(FSOUND_SAMPLE *sptr, signed char loop);
DLL_API2 signed char     F_API FSOUND_Record_Stop();
DLL_API2 int             F_API FSOUND_Record_GetPosition();  
...
DLL_API2 FMUSIC_MODULE * F_API FMUSIC_LoadSong(const char *name);
DLL_API2 FMUSIC_MODULE * F_API FMUSIC_LoadSongEx(const char *name_or_data, int offset, int length, unsigned int mode, const int *samplelist, int samplelistnum);
DLL_API2 int             F_API FMUSIC_GetOpenState(FMUSIC_MODULE *mod);
DLL_API2 signed char     F_API FMUSIC_FreeSong(FMUSIC_MODULE *mod);
DLL_API2 signed char     F_API FMUSIC_PlaySong(FMUSIC_MODULE *mod);
DLL_API2 signed char     F_API FMUSIC_StopSong(FMUSIC_MODULE *mod);
DLL_API2 void            F_API FMUSIC_StopAllSongs();

DLL_API2 signed char     F_API FMUSIC_SetZxxCallback(FMUSIC_MODULE *mod, FMUSIC_CALLBACK callback);
DLL_API2 signed char     F_API FMUSIC_SetRowCallback(FMUSIC_MODULE *mod, FMUSIC_CALLBACK callback, int rowstep);
DLL_API2 signed char     F_API FMUSIC_SetOrderCallback(FMUSIC_MODULE *mod, FMUSIC_CALLBACK callback, int orderstep);
DLL_API2 signed char     F_API FMUSIC_SetInstCallback(FMUSIC_MODULE *mod, FMUSIC_CALLBACK callback, int instrument);

DLL_API2 signed char     F_API FMUSIC_SetSample(FMUSIC_MODULE *mod, int sampno, FSOUND_SAMPLE *sptr);
DLL_API2 signed char     F_API FMUSIC_SetUserData(FMUSIC_MODULE *mod, unsigned int userdata);
DLL_API2 signed char     F_API FMUSIC_OptimizeChannels(FMUSIC_MODULE *mod, int maxchannels, int minvolume);

/*
    Runtime song functions. 
*/

DLL_API2 signed char     F_API FMUSIC_SetReverb(signed char reverb);             /* MIDI only */
DLL_API2 signed char     F_API FMUSIC_SetLooping(FMUSIC_MODULE *mod, signed char looping);
DLL_API2 signed char     F_API FMUSIC_SetOrder(FMUSIC_MODULE *mod, int order);
DLL_API2 signed char     F_API FMUSIC_SetPaused(FMUSIC_MODULE *mod, signed char pause);
DLL_API2 signed char     F_API FMUSIC_SetMasterVolume(FMUSIC_MODULE *mod, int volume);
DLL_API2 signed char     F_API FMUSIC_SetMasterSpeed(FMUSIC_MODULE *mode, float speed);
DLL_API2 signed char     F_API FMUSIC_SetPanSeperation(FMUSIC_MODULE *mod, float pansep);
 
/* 
    Static song information functions.
*/

DLL_API2 const char *    F_API FMUSIC_GetName(FMUSIC_MODULE *mod);
DLL_API2 int             F_API FMUSIC_GetType(FMUSIC_MODULE *mod);
DLL_API2 int             F_API FMUSIC_GetNumOrders(FMUSIC_MODULE *mod);
DLL_API2 int             F_API FMUSIC_GetNumPatterns(FMUSIC_MODULE *mod);
DLL_API2 int             F_API FMUSIC_GetNumInstruments(FMUSIC_MODULE *mod);
DLL_API2 int             F_API FMUSIC_GetNumSamples(FMUSIC_MODULE *mod);
DLL_API2 int             F_API FMUSIC_GetNumChannels(FMUSIC_MODULE *mod);
DLL_API2 FSOUND_SAMPLE * F_API FMUSIC_GetSample(FMUSIC_MODULE *mod, int sampno);
DLL_API2 int             F_API FMUSIC_GetPatternLength(FMUSIC_MODULE *mod, int orderno);
 
/* 
    Runtime song information.
*/

DLL_API2 signed char     F_API FMUSIC_IsFinished(FMUSIC_MODULE *mod);
DLL_API2 signed char     F_API FMUSIC_IsPlaying(FMUSIC_MODULE *mod);
DLL_API2 int             F_API FMUSIC_GetMasterVolume(FMUSIC_MODULE *mod);
DLL_API2 int             F_API FMUSIC_GetGlobalVolume(FMUSIC_MODULE *mod);
DLL_API2 int             F_API FMUSIC_GetOrder(FMUSIC_MODULE *mod);
DLL_API2 int             F_API FMUSIC_GetPattern(FMUSIC_MODULE *mod);
DLL_API2 int             F_API FMUSIC_GetSpeed(FMUSIC_MODULE *mod);
DLL_API2 int             F_API FMUSIC_GetBPM(FMUSIC_MODULE *mod);
DLL_API2 int             F_API FMUSIC_GetRow(FMUSIC_MODULE *mod);
DLL_API2 signed char     F_API FMUSIC_GetPaused(FMUSIC_MODULE *mod);
DLL_API2 int             F_API FMUSIC_GetTime(FMUSIC_MODULE *mod);
DLL_API2 int             F_API FMUSIC_GetRealChannel(FMUSIC_MODULE *mod, int modchannel);
DLL_API2 unsigned int    F_API FMUSIC_GetUserData(FMUSIC_MODULE *mod);
