...
"    varying    highp   vec3    invertView;                                                                                                                     \n" 
     ...
     //========================----------------
      ...
      "         shadowTexcoord         =   shadowTexcoord / shadowTexcoord.w;                                                                  \n"      
                //---------------------------------------------------------------------------------------------------------
      "         lightPosition_PASS     =  normalize(lightMatrix * light_POSITION_01 - position);                                                          \n"        
      "         lightPosition_PASS_02  =  normalize(lightMatrix * light_POSITION_02 - position);                                                          \n"        
      "         lightPosition_PASS_03  =  normalize(lightMatrix * light_POSITION_03 - position);                                                          \n"        
      "         lightPosition_PASS_04  =  normalize(lightMatrix * light_POSITION_04 - position);                                                          \n"        
...
"        invertView             = normalize(Vertex.xyz * inverseEye.w - inverseEye.xyz * Vertex.w);                                                             \n"  
      ...
      //========================---------------- // fire_fresnel
      "    uniform sampler2D   Texture_FRESNEL;                                                                                                         \n"                       
      ...
      "         fresnelTexture             =  texture2D(Texture_FRESNEL, 0.5 + 0.5 * normalize(Reflect + vec3(0.0, 0.0, 1.0)).xy) * 4.0;                                        \n" 
      ...
      "         fresnelTexture.a           =  opacity;                                                                                             \n"
     
      "         highp vec4 tempColor_01;                                                                                                           \n"    
   
      "         tempColor_01              =  (texture2D(Texture1, varTexcoord.st)* NdotL1 * NdotL1                                                 \n"   
      ...
      "        tempColor_01.a             = opacity + (gloss_01.x + gloss_02.x + gloss_04.x) * .15;                                     \n" 
      
      "        gl_FragColor               =   mix(tempColor_01, fresnelTexture,fresnel-tempColor_01.b*0.2) * NdotL1 * NdotL4;                      \n" 
      ...
      UNIFORM_TEXTURE_FRESNEL_jadeMonkey                 = glGetUniformLocation(jadeMonkey_SHADER,      "Texture_FRESNEL");       
...
//----------------------------------------------------------------------------------------------------------------------------                                                                   
      #ifdef WIN32  
      loadTexture("_SHADERS/stone/jadeMonkey/light_brownMarble.png",                bronze_FRESNELMAP);       
      #endif 
